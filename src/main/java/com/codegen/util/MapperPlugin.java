...
//                mapperInterface.addMethod(deleteByPrimaryKey);
                ...
                baseMapperType.addTypeArgument(baseModelJavaType);

                mapperInterface.addImportedType(new FullyQualifiedJavaType("com.baomidou.mybatisplus.core.mapper.BaseMapper"));
                mapperInterface.addSuperInterface(baseMapperType);
